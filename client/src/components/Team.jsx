  ...
  >
    ...
    <div className="relative h-[420px] overflow-hidden">
      ...
      <div className="absolute top-4 right-4">
        <span className="bg-[#F97316] text-white text-xs font-bold px-4 py-1.5 rounded-full shadow">
          {m.tag}
        </span>
      </div>
      ...
      <div className="absolute bottom-5 left-5 z-10">
        ...
        <p className="text-[#F97316] text-sm font-semibold mt-1">
          {m.role}
        </p>
      </div>
    </div>
    ...
    <div className="p-6">
      ...
      <a
        href={`tel:${m.phone}`}
        className="flex items-center gap-2 text-sm font-semibold text-[#1F1F1F] hover:text-[#F97316] transition-colors"
      >
